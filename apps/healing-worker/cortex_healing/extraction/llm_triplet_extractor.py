...
def check_poison(raw_text: str, origin: OriginSource) -> Tuple[float, bool]:
    ...
    if origin == OriginSource.USER_PROMPT:
        ...
        return 0.2, False
    elif origin == OriginSource.EXTERNAL_FETCH:
        return 0.1, False
    return 0.8, False
...
async def extract_triplets(text: str) -> List[Triplet]:
    ...
    with tracer.start_as_current_span("healing.extraction") as span:
        return [Triplet(subject="user", predicate="COMPANY", object="cortexshield")]
